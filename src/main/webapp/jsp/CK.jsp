	...
	<body>
						...
						<div class="fabu2_inm">
							<div class="fabu2_inmUnit">
								<div class="fabu2_inmLeft">
									信息标题：<A>${checkSupply.data.title}</A>
								</div>
							</div>
							<div class="fabu2_inmUnit">
								...
								<div class="fabu2_inmRight">
									...
									<div class="fabu2_inmShu">
										<div class="fabu2_shuLeft">
										商品名称：<a>${checkSupply.data.productName}D</a>
										</div>
									</div>
									<div class="fabu2_inmShu " id="regionSelected">
										...
										地区：
										 ...
										 <div id="regionMsg">
										      <span>${checkSupply.data.region.SHENG}</span>&nbsp;&nbsp;<span>${checkSupply.data.region.SHI}</span>&nbsp;&nbsp;<span>${checkSupply.data.region.XIAN}</span>&nbsp;&nbsp;
										      &nbsp;&nbsp;
										   </div>
									...
									<div class="fabu2_inmShu">
										<div class="fabu2_shuLeft">
										数量：<A>${checkSupply.data.count}</A>
										</div>
									</div>
									<div class="fabu2_inmShu">
										<div class="fabu2_shuLeft">
										价格：<A>${checkSupply.data.price}</A>
										</div>
									</div>
									<div class="fabu2_inmShu">
										<div class="fabu2_shuLeft">
										联系电话：<A>${checkSupply.data.tel}</A>
										</div>
									</div>
								</div>
							</div>
					...
					<div class="fabu2_unit">
						...
						<div class="fabu2_inm">
							<div class="fabu2_picUnit">
								<a class="picString selectDiv" >${checkSupply.data.pictrue}</a>
								<div class="picDiv">
		...
		<script type="text/javascript">
          ...
          for(var i=0;i<picString.length;i++){
             picDiv.append("<img src='http://192.168.0.166:8088/douding/51douding/"+picString[i]+"'\/>");
           
          }
           var a = $("img[src='http://192.168.0.166:8088/douding/51douding/']").addClass("selectDiv");
        </script>
