			...
			<div class="navLeft_ht">
				<div class="info">
					...
					<div class="infone">
						...
						<div class="onedown">
							<div class="odin">
								<a href="${pageContext.request.contextPath}../jsp/FBGY.jsp">发布供应产品</a><div class="rightimg"><img src="../img/rightward.png" /></div>
							</div>
						</div>
						<div class="onedown">
							<div class="odin">
			...
			<div class="mainRight_ht">
				<div class="iwf">
					<div class="iwfb">
						...
						<div class="iwfb-r">
							<a href="FBXX2.jsp" target="FBXX2"><input type="button" name="" value="我要发布"/ class="btn"></a>
						</div>
					</div>
					<div class="phend">
