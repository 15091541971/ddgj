...
<html>
	<head>
		...
		<script t src="../layui/layui.js"></script> 
		      ...
		      $.ajax({
                ...
                success:function(result){
                 ...
                 var spantext = $(".fabu_allChoose_msg_parent").text(test.text()+":");
                   $.ajax({
                     url:"<%=path%>/ideado/selectTypeByParent.do?type_parent="+index,
                     type:"post",
                     dataType:"json",
                     success:function(json){
                      $.each(json.data,function(x,typeName){        //获取子类别
	   ...
	   layer.msg("发布成功");
		...
		<div class="mainHT">
			<div class="fabu_content">
				...
				<form class="fabu_main2" action="<%=path%>/demand/addDemand.do" method="post" enctype="multipart/form-data">
