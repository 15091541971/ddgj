...
import com.douding.lmc.tool.JsonTool;
import com.douding.lmc.tool._Global;
		...
		try{
			...
			if(code==HttpStatus.SC_OK){
				...
				if(entity!=null){
					...
					node= (TalkNode) JsonTool.read(json,TalkNode.class);
					node.setStatusCode(new Integer(code));
					return node;
