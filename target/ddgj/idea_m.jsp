...
<tr><td><label>userid</label></td><td><input type="text" name="fromId.userId"></td></tr>
...
<hr>
<form action="<%=request.getContextPath()%>/ideado/addComment.do">
<label>userId</label><input name="user.userId" type="text"><br>
<label>idea_id</label><input name="idea_id" type="text"><br>
<label>context</label><input name="context" type="text"><br>
