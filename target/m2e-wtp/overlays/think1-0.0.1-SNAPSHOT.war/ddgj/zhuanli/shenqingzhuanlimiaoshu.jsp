...
<head>
    ...
    <link rel="stylesheet" href="../css/shenqingzhuanlimiaoshu.css">
    <title>申请专利</title>
</head>
<body>
<!--顶部-->
...
<div class="fabu">
    ...
    <div class="fbnr">
        ...
        <form class="msnr" action="" method="get">
            ...
            <p class="msn">专利用途</p>
            <input class="msnk" type="text" title="search" placeholder="">
            <p class="msnt">技术描述:</p>
            ...
            <!--<div class="tjimg">-->
                ...
                <!--&lt;!&ndash;<input type="submit" name="Submit" value="添加" />&ndash;&gt;-->
            <!--</div>-->
