...
<a href="<%=request.getContextPath()%>/ideado/selectIdeaByIdeaId.do?idea_id=1490155256825">根据id查找创意</a><br><br>
<a href="<%=request.getContextPath()%>/ideado/addIdeaPraise.do?idea_id=1490155256825&user_id=1489202507754">点赞</a><br><br>
<a href="<%=request.getContextPath()%>/ideado/removeFavoriteIdea.do?idea_id=1490155256825&user_id=1489202507754">取消点赞</a><br><br>
